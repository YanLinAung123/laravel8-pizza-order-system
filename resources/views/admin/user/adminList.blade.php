                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools d-flex">
                                    <a href="{{route('admin#adminListDownload')}}" class="me-3" class="mt-1">
                                    ...
                                    <tbody>
                                        @foreach ($admin as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->address }}</td>
                                                <td>
                                                    <a href="{{ route('admin#deleteAdminList', $item->id) }}"><button
                                                            class="btn btn-sm bg-danger text-white"><i
                                                                class="fas fa-trash-alt"></i></button></a>
                                                    <a href="{{ route('admin#editAdminList', $item->id) }}"><button
                            ...
                            <div class="card-footer text-dark p-0">
                                <div class="ms-5 text-warning">
                                    <p class="text-dark bg-dark">{{ $admin->links() }}</p>
                                </div>
                            </div>
                        </div>

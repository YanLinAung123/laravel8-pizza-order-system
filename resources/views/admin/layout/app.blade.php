                            ...
                            <a href="" class="nav-link">
                                ...
                                <p>
                                    <form action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        {{-- <button type="submit" class="btn-border"><i class="fas fa-sign-out-alt"></i>Logout</button> --}}
                                        <i class="fas fa-sign-out-alt"></i><input type="submit" style="border: none; outline:none;" class="bg-dark" value="Logout">
                                    </form>
                                </p>
                            </a>
                        </li>

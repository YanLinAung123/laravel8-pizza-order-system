...
class PizzaController extends Controller
{
     ...
     public function pizza()
     {
         ...
         return Response::json(['pizza' => $pizza, 'emptyStatus' => $emptyStatus]);
     }
     ...
     public function insertPizza(Request $request)
     {
         ...
         Pizza::create($data);
         return Response::json(['createSuccess' => "Pizza Created..."]);
     }
     // Info pizza
     ...
     public function editPizza($id)
     {
         ...
         return Response::json(['pizza' => $data, 'category' => $category]);
     }
     // Update Pizza
        ...
        $updateData= $this->requestUpdateData($request);
         if(isset($updateData['image'])){
            ...
            $updateData['image']=$fileName;
             ...
             return Response::json(['updateSuccess'=>"Pizza Updated.."]);
     }
     // Delete Pizza
     public function deletePizza($id)
     {
         ...
         return Response::json(['deleteSuccess' => 'Pizza Deleted..']);
     ...
     public function searchPizza(Request $request)
     {
         ...
         return Response::json(['pizza'=>$searchData,'emptyStatus' => $emptyStatus]);
     }
     // pizza Download

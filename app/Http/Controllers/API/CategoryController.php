...
class CategoryController extends Controller
{
    ...
    public function category()
    {
        ...
        $data = Category::select('categories.*',DB::raw('COUNT(pizzas.category_id) as count'))
                ...
                ->paginate(5);
        return Response::json(['categoryData' => $data]);
    }
    ...
    public function createCategory(Request $request)
    {
        ...
        return Response::json(['successCreate' => "New Category Added"]);
    }
        // Edit Category
    ...
    public function updateCategory(Request $request)
    {
        ...
        return Response::json(['successUpdate' => " Category Updated..."]);
    }
    // Delete Category
    public function deleteCategory($id)
    {
        Category::where('category_id', $id)->delete();
        return Response::json(['successDelete' => "Deleted Success...."]);
    }
    ...
    public function searchCategory(Request $request)
    {
        ...
        return Response::json(['categoryData' => $searchData]);
    }

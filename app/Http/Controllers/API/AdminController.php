...
class AdminController extends Controller
{
    ...
    public function profile()
    {
        ...
        return Response::json(['userData' => $dataUser]);
    }
    // Update Profile...
    public function updateProfile($id, Request $request)
    {
        ...
        return Response::json(['updateSuccess'=>"User Information Updated.."]);
    }
   // Change Password
        ...
        if(Hash::check($oldPassword, $dbOldPassword)){
            if($newPassword==$confirmPassword){
                if(strlen($newPassword)>=6||strlen($confirmPassword)>=6){
                    ...
                    return Response::json(['updateSuccess'=>"Password Changed!"]);
                }else{
     ...
     public function adminSearch(Request $request)
    {
       ...
       $response=$this->searchData($request,'admin');
           return Response::json(['admin'=>$response]);
    }

     // delete User Account
    public function deleteUserList($id){
        User::where('id',$id)->delete();
        return Response::json(['deleteSuccess'=>"Account Deleted!"]);
    }
    // Edit admin list
